...
func _ready():
	# Connecting the event start and end signals
...
func add_choice_button(option):
	...
	if theme.get_value('buttons', 'text_color_enabled', true):
		...
		button.set('custom_colors/font_color_hover', button_text_color.darkened(0.2))
		button.set('custom_colors/font_color_pressed', button_text_color.darkened(0.4))
